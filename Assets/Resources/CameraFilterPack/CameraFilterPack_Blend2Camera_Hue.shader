  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float3 tmpvar_7;
          float _tmp_dvx_34 = (1 - _Value2);
          tmpvar_7 = lerp(tex_2.xyz, tex2_1.xyz, float3(_tmp_dvx_34, _tmp_dvx_34, _tmp_dvx_34));
          float4 tmpvar_8;
          ...
          float4 tmpvar_10;
          float _tmp_dvx_35 = float((tmpvar_7.y>=tmpvar_7.z));
          tmpvar_10 = lerp(tmpvar_8, tmpvar_9, float4(_tmp_dvx_35, _tmp_dvx_35, _tmp_dvx_35, _tmp_dvx_35));
          float4 tmpvar_11;
          ...
          float4 tmpvar_13;
          float _tmp_dvx_36 = float((tmpvar_7.x>=tmpvar_10.x));
          tmpvar_13 = lerp(tmpvar_11, tmpvar_12, float4(_tmp_dvx_36, _tmp_dvx_36, _tmp_dvx_36, _tmp_dvx_36));
          float tmpvar_14;
          ...
          float4 tmpvar_18;
          float _tmp_dvx_37 = float((tmpvar_6.y>=tmpvar_6.z));
          tmpvar_18 = lerp(tmpvar_16, tmpvar_17, float4(_tmp_dvx_37, _tmp_dvx_37, _tmp_dvx_37, _tmp_dvx_37));
          float4 tmpvar_19;
          ...
          float4 tmpvar_21;
          float _tmp_dvx_38 = float((tmpvar_6.x>=tmpvar_18.x));
          tmpvar_21 = lerp(tmpvar_19, tmpvar_20, float4(_tmp_dvx_38, _tmp_dvx_38, _tmp_dvx_38, _tmp_dvx_38));
          float tmpvar_22;
          ...
          float4 tmpvar_24;
          tmpvar_24.w = 1;
          tmpvar_24.xyz = lerp(tmpvar_6, (tmpvar_13.x * lerp(float3(1, 1, 1), clamp((abs(((frac((tmpvar_23.xxx + float3(1, 0.6666667, 0.3333333))) * 6) - float3(3, 3, 3))) - float3(1, 1, 1)), float3(0, 0, 0), float3(1, 1, 1)), tmpvar_15.yyy)), float3(_Value, _Value, _Value));

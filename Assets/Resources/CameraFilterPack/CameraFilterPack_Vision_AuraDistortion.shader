  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          color_2 = ((_Value2.xyz * a_4) * tmpvar_16);
          float4 tmpvar_54;
          float2 P_55;
          float _tmp_dvx_105 = (((color_2.x + color_2.y) + color_2.z) / 3);
          P_55 = (in_f.xlv_TEXCOORD0 + float2(_tmp_dvx_105, _tmp_dvx_105));
          tmpvar_54 = tex2D(_MainTex, P_55);
          v_1 = tmpvar_54;
          color_2 = v_1.xyz;
          float4 tmpvar_56;
          tmpvar_56.w = 1;
          tmpvar_56.xyz = float3(color_2);
          out_f.color = tmpvar_56;
          return out_f;
      }

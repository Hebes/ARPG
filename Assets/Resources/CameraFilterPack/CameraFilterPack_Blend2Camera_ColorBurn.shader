  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float4 tmpvar_7;
          tmpvar_7.w = 1;
          float _tmp_dvx_40 = (1 - _Value2);
          tmpvar_7.xyz = lerp(tmpvar_6, (1 - ((1 - lerp(tex_2.xyz, tex2_1.xyz, float3(_tmp_dvx_40, _tmp_dvx_40, _tmp_dvx_40))) / tmpvar_6)), float3(_Value, _Value, _Value));

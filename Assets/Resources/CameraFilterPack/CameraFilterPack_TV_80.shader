  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float4 tmpvar_9;
          float2 P_10;
          float _tmp_dvx_20 = ((0.55 * tmpvar_8) + (q_4 + float2(0.001, 0.001)));
          P_10 = float2(_tmp_dvx_20, _tmp_dvx_20);
          ...
          col_3 = (col_3 * (0.4 + (0.7 * pow(clamp((0.35 + (0.35 * sin(((3.5 * _TimeX) + ((q_4.y * _ScreenResolution.y) * 1.5))))), 0, 1), 1.7))));
          col_3 = (col_3 * ((1 + (0.01 * sin((110 * _TimeX)))) + (clamp(floor((sin(((q_4.y * 6) + (_TimeX * 2.6))) + 1.95)), 0, 1.1) / 4)));

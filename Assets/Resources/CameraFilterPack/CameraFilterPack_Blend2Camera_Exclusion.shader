  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float3 tmpvar_7;
          float _tmp_dvx_27 = (1 - _Value2);
          tmpvar_7 = lerp(tex_2.xyz, tex2_1.xyz, float3(_tmp_dvx_27, _tmp_dvx_27, _tmp_dvx_27));
          float4 tmpvar_8;
          tmpvar_8.w = 1;
          tmpvar_8.xyz = float3(lerp(tmpvar_6, ((tmpvar_6 + tmpvar_7) - ((2 * tmpvar_6) * tmpvar_7)), float3(_Value, _Value, _Value)));

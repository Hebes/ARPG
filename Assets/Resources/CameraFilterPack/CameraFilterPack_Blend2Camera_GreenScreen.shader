  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          d_6.xz = tex2_1.xz;
          float tmpvar_7;
          tmpvar_7 = max(tex2_1.x, tex2_1.z);
          d_6.y = min((tex2_1.y - _Value2), (tmpvar_7 * 0.8));
          d_6 = (d_6 + ((tex2_1.y - d_6.y) - _Value4));
          d_6.x = (d_6.x + _Value5);
          d_6.z = (d_6.z + _Value6);
          d_6.y = (d_6.y + _Value7);
          float4 tmpvar_8;
          tmpvar_8.w = 1;
          float _tmp_dvx_49 = clamp((((tex2_1.y - tmpvar_7) - _Value3) * 3), 0, 1);
          tmpvar_8.xyz = lerp(d_6, tex_2.xyz, float3(_tmp_dvx_49, _tmp_dvx_49, _tmp_dvx_49));
          float4 tmpvar_9;

      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          while((i_1_1<12))
          {
              ...
              while((j_11<10))
              {
                  ...
                  p_2 = tmpvar_12;
                  k_7 = (k_7 + exp((-2 * abs(dot(tmpvar_12, o_4)))));
                  j_11 = (j_11 + 1);
              }
              k_7 = (k_7 / 3);
              o_4 = (o_4 + ((d_5 * 0.5) * k_7));
              ...
              tmpvar_13.z = _Value4;
              float _tmp_dvx_51 = ((0.97 * c_3) + ((0.1 * k_7) * tmpvar_13));
              c_3 = float3(_tmp_dvx_51, _tmp_dvx_51, _tmp_dvx_51);
              i_1_1 = (i_1_1 + 1);
          }
          float2 x_14;
          ...
          float _tmp_dvx_52 = (0.4 * log((1 + c_3)));
          c_3 = float3(_tmp_dvx_52, _tmp_dvx_52, _tmp_dvx_52);
          float2 tmpvar_16;
          ...
          float3 tmpvar_20;
          float _tmp_dvx_53 = (1 - (tmpvar_15 * (tmpvar_15 * (3 - (2 * tmpvar_15)))));
          tmpvar_20 = lerp(tmpvar_18, tmpvar_19, float4(_tmp_dvx_53, _tmp_dvx_53, _tmp_dvx_53, _tmp_dvx_53)).xyz;
          c_3 = tmpvar_20;
          float4 tmpvar_21;
          tmpvar_21.w = 1;

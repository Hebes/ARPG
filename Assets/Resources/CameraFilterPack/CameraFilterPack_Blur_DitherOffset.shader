    ...
    Pass // ind: 1, name: 
    {
      ...
      float4 impl_low_texture2DLodEXT(sampler2D sampler, float2 coord, float lod)
      {
          ...
          OUT_Data_Frag frag(v2f in_f)
          {
              ...
              float2 tmpvar_12;
              tmpvar_12 = (tmpvar_10 + ((0.5 * float((0.5>=frac((sin(dot((uv_6 + frac(_TimeX)), float2(12.9898, 78.233))) * 43758.55))))) * tmpvar_11));
              p_3 = tmpvar_12;
              float4 tmpvar_13;
              tmpvar_13 = impl_low_texture2DLodEXT(_MainTex, tmpvar_12, 0);
              float4 tmpvar_14;
              tmpvar_14 = tmpvar_13;
              sum_2 = tmpvar_14;
              i_1_1 = 1;
              ...
              {
                  float4 tmpvar_15;
                  tmpvar_15 = impl_low_texture2DLodEXT(_MainTex, p_3, 0);

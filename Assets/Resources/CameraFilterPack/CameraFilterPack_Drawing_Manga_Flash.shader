  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float tmpvar_9;
          float _tmp_dvx_80 = ((floor((((tmpvar_6 + tmpvar_4) / (2 * tmpvar_4)) * 700)) / 700) * max((floor((_TimeX * _Value2)) / _Value2), 0.1));
          tmpvar_9 = ((frac((sin(dot(float2(_tmp_dvx_80, _tmp_dvx_80), float2(12.9898, 78.233))) * 43758.55)) * 0.7) + 0.3);
          float tmpvar_10;
